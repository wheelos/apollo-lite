...
class Scu1121 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // 'GW_LowBeam_Req', 'offset': 0.0, 'order': 'intel', 'physical_range':
  ...
  // 'GW_Right_Turn_Light_Req', 'offset': 0.0, 'order': 'intel',
  ...
  // 'GW_Left_Turn_Light_Req', 'offset': 0.0, 'order': 'intel',
  // 'physical_range': '[0|3]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'int'}
 ...
 private:
  ...
  // 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'int'}
  void set_p_scu_steering_wheel_angle_r(uint8_t* data,
  ...
  // 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'int'}
  void set_p_scu_steering_wheel_angle_f(uint8_t* data,
  ...
  // 'physical_range': '[0|3]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'int'}
  void set_p_gw_right_turn_light_req(uint8_t* data,
  ...
  bool angular_speed_flag(const std::uint8_t* bytes,
                          const int32_t length) const;

  int scu_steering_wheel_angle_r(const std::uint8_t* bytes,
                                 const int32_t length) const;

  int scu_steering_wheel_angle_f(const std::uint8_t* bytes,
                                 const int32_t length) const;

  int gw_lowbeam_req(const std::uint8_t* bytes, const int32_t length) const;

  int gw_position_light_req(const std::uint8_t* bytes,
                            const int32_t length) const;

  int gw_right_turn_light_req(const std::uint8_t* bytes,
                              const int32_t length) const;

  int gw_left_turn_light_req(const std::uint8_t* bytes,
                             const int32_t length) const;

  bool scu_brk_en(const std::uint8_t* bytes, const int32_t length) const;

  double scu_target_speed(const std::uint8_t* bytes,
                          const int32_t length) const;
