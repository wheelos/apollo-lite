...
class Waringlevel77 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int turn_unstoppable_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int turn_disconnect_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int mcu_temperature_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int mcu_disconnect_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int bms_temperature_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int bms_dischargecur_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int bms_chargecur_warning(const std::uint8_t* bytes, const int32_t length) const;
};
