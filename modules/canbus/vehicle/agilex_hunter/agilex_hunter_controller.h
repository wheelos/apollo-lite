...
class Agilex_hunterController final : public VehicleController {
 public:

  explicit Agilex_hunterController() {};

  virtual ~Agilex_hunterController();
 ...
 private:
  // control protocol
  Controlmodecommand421* control_mode_command_421_ = nullptr;
  Errorclearcommand441* error_clear_command_441_ = nullptr;
  Motioncommand111* motion_command_111_ = nullptr;
  Steeringzeroquery433* steering_zero_query_433_ = nullptr;
  Steeringzeroset432* steering_zero_set_432_ = nullptr;
