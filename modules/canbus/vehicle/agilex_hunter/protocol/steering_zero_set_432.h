...
class Steeringzeroset432 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  Steeringzeroset432* set_zero_offset_h(int zero_offset_h);

 private:

  // config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name': 'Zero_Offset_H', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
  void set_p_zero_offset_h(uint8_t* data, int zero_offset_h);
