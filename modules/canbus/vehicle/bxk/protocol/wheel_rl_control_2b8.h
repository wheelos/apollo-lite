...
class Wheelrlcontrol2b8 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  Wheelrlcontrol2b8* set_speed_rl_ctrl(int speed_rl_ctrl);
  ...
  Wheelrlcontrol2b8* set_runningstate_rl(Wheel_rl_control_2b8::Runningstate_rlType runningstate_rl);
  ...
  Wheelrlcontrol2b8* set_directionstate_rl(Wheel_rl_control_2b8::Directionstate_rlType directionstate_rl);

 private:

  // config detail: {'bit': 0, 'is_signed_var': True, 'len': 32, 'name': 'Speed_rl_Ctrl', 'offset': 0.0, 'order': 'intel', 'physical_range': '[0|1000]', 'physical_unit': 'RPM', 'precision': 1.0, 'type': 'int'}
  void set_p_speed_rl_ctrl(uint8_t* data, int speed_rl_ctrl);

  // config detail: {'bit': 32, 'enum': {0: 'RUNNINGSTATE_RL_STOPPED', 2: 'RUNNINGSTATE_RL_RUNNING'}, 'is_signed_var': False, 'len': 8, 'name': 'RunningState_rl', 'offset': 0.0, 'order': 'intel', 'physical_range': '[0|2]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_runningstate_rl(uint8_t* data, Wheel_rl_control_2b8::Runningstate_rlType runningstate_rl);

  // config detail: {'bit': 40, 'enum': {0: 'DIRECTIONSTATE_RL_REVERSE', 1: 'DIRECTIONSTATE_RL_FORWARD'}, 'is_signed_var': False, 'len': 8, 'name': 'DirectionState_rl', 'offset': 0.0, 'order': 'intel', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_directionstate_rl(uint8_t* data, Wheel_rl_control_2b8::Directionstate_rlType directionstate_rl);
 ...
 private:
  int speed_rl_ctrl_;
  Wheel_rl_control_2b8::Runningstate_rlType runningstate_rl_;
  Wheel_rl_control_2b8::Directionstate_rlType directionstate_rl_;
};
