...
class Wheelfrcontrol2b6 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  Wheelfrcontrol2b6* set_speed_fr_ctrl(int speed_fr_ctrl);
  ...
  Wheelfrcontrol2b6* set_runningstate_fr(Wheel_fr_control_2b6::Runningstate_frType runningstate_fr);
  ...
  Wheelfrcontrol2b6* set_directionstate_fr(Wheel_fr_control_2b6::Directionstate_frType directionstate_fr);

 private:

  // config detail: {'bit': 0, 'is_signed_var': True, 'len': 32, 'name': 'Speed_fr_Ctrl', 'offset': 0.0, 'order': 'intel', 'physical_range': '[0|1000]', 'physical_unit': 'RPM', 'precision': 1.0, 'type': 'int'}
  void set_p_speed_fr_ctrl(uint8_t* data, int speed_fr_ctrl);

  // config detail: {'bit': 32, 'enum': {0: 'RUNNINGSTATE_FR_STOPPED', 2: 'RUNNINGSTATE_FR_RUNNING'}, 'is_signed_var': False, 'len': 8, 'name': 'RunningState_fr', 'offset': 0.0, 'order': 'intel', 'physical_range': '[0|2]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_runningstate_fr(uint8_t* data, Wheel_fr_control_2b6::Runningstate_frType runningstate_fr);

  // config detail: {'bit': 40, 'enum': {0: 'DIRECTIONSTATE_FR_REVERSE', 1: 'DIRECTIONSTATE_FR_FORWARD'}, 'is_signed_var': False, 'len': 8, 'name': 'DirectionState_fr', 'offset': 0.0, 'order': 'intel', 'physical_range': '[0|1]', 'physical_unit': '', 'precision': 1.0, 'type': 'enum'}
  void set_p_directionstate_fr(uint8_t* data, Wheel_fr_control_2b6::Directionstate_frType directionstate_fr);
 ...
 private:
  int speed_fr_ctrl_;
  Wheel_fr_control_2b6::Runningstate_frType runningstate_fr_;
  Wheel_fr_control_2b6::Directionstate_frType directionstate_fr_;
};
