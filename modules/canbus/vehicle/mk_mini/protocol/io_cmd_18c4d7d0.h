...
class Iocmd18c4d7d0 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // 'io_cmd_speaker', 'offset': 0.0, 'order': 'intel', 'physical_range':
  // '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
  ...
  // 'bool'}
  Iocmd18c4d7d0* set_io_cmd_upper_beam_headlamp(
  ...
  // 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'bool'}
  Iocmd18c4d7d0* set_io_cmd_lower_beam_headlamp(
      bool io_cmd_lower_beam_headlamp);

  // config detail: {'bit': 0, 'is_signed_var': False, 'len': 1, 'name':
  // 'io_cmd_enable', 'offset': 0.0, 'order': 'intel', 'physical_range':
  // '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type': 'bool'}
 ...
 private:
  ...
  // 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'bool'}
  void set_p_io_cmd_upper_beam_headlamp(uint8_t* data,
                                        bool io_cmd_upper_beam_headlamp);
  ...
  // 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'bool'}
  void set_p_io_cmd_lower_beam_headlamp(uint8_t* data,
                                        bool io_cmd_lower_beam_headlamp);
  ...
  bool io_cmd_clearance_lamp(const std::uint8_t* bytes,
                             const int32_t length) const;

  bool io_cmd_braking_lamp(const std::uint8_t* bytes,
                           const int32_t length) const;

  int io_cmd_turn_lamp(const std::uint8_t* bytes, const int32_t length) const;

  bool io_cmd_upper_beam_headlamp(const std::uint8_t* bytes,
                                  const int32_t length) const;

  bool io_cmd_lower_beam_headlamp(const std::uint8_t* bytes,
                                  const int32_t length) const;
