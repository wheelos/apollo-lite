...
class OpenSpaceInfo {
 public:
  ...
  bool parking_enforce_final_gear() const {
    return parking_enforce_final_gear_;
  }

  void set_parking_enforce_final_gear(const bool enforce_final_gear) {
    parking_enforce_final_gear_ = enforce_final_gear;
  }
 ...
 private:
  ...
  bool parking_enforce_final_gear_ = false;
