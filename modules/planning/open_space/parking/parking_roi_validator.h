...
class ParkingRoiValidator {
 public:
  ...
  // Goal validation is intentionally limited to envelope membership. Clearance is
  // still reported as a debug metric, but candidate feasibility and clearance
  // trade-offs are handled by ParkingPoseSelector rather than hard-rejected here.
