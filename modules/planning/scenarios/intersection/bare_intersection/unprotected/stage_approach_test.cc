...
#include "modules/planning/scenarios/intersection/bare_intersection/unprotected/stage_approach.h"
...
class StageApproachTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    config_.set_stage_type(StageType::BARE_INTERSECTION_UNPROTECTED_APPROACH);
...
TEST_F(StageApproachTest, Init) {
  ...
  EXPECT_EQ(bare_intersection_unprotected_stage_approach.Name(),
            StageType_Name(StageType::BARE_INTERSECTION_UNPROTECTED_APPROACH));
}
