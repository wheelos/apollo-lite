...
class CubicPolynomialCurve1d final : public PolynomialCurve1d {
 public:
  CubicPolynomialCurve1d(const std::array<double, 3>& start, double end,
                         double parameter);
  CubicPolynomialCurve1d(double x0, double dx0, double ddx0, double x1,
                         double parameter);
 ...
 private:
  ...
  std::array<double, 4> coefficients_{{0.0, 0.0, 0.0, 0.0}};
};
