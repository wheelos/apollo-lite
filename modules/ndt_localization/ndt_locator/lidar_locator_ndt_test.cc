...
TEST(LidarLocatorNdtTestSuite, LidarLocatorNdt) {
  const std::string map_folder =
      "/apollo/modules/ndt_localization/test_data/ndt_map";
  const std::string poses_file =
      "/apollo/modules/ndt_localization/test_data/pcds/poses.txt";
  ...
  for (; frame_idx < poses.size(); ++frame_idx) {
    ...
    std::string pcd_file_path =
        "/apollo/modules/ndt_localization/test_data/pcds/" + ss.str() + ".pcd";
