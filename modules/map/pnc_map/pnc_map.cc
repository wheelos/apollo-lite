...
bool PncMap::IsNewRouting(const routing::RoutingResponse &prev,
  ...
  // TODO(zero): This validation code is commented out because it needs to be
  // updated to handle "waypoints only" mode. If this mode is implemented in
  // the future, revisit and update the validation logic below:
