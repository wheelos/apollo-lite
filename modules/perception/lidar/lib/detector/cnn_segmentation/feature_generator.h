...
struct StFeatureParam {
  float point_cloud_range = 60.0;
  uint32_t width = 512;
  uint32_t height = 512;
  ...
  bool use_intensity_feature = true;
  bool use_constant_feature = true;
};
...
class FeatureGenerator {
 public:
  ...
  bool Init(const StFeatureParam& feature_param, base::Blob<float>* out_blob);
