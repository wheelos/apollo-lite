...
#include "modules/perception/pipeline/proto/stage/graph_segmentation_config.pb.h"
...
class GraphClusterSegmenter : public BaseLidarDetector {
 public:
   ...
   * @param frame
   */
  bool SetBgObjectDefaultVal(LidarFrame* frame);
 ...
 private:
  ...
  common::GraphSegmentor graph_segmentor_;
