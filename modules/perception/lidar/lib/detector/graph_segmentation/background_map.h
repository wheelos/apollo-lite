...
class BackgroundMap {
 public:
  ...
  bool Init(float xmin, float xmax, float ymin, float ymax, float resolution,
            float height_threshold, float car_xmin, float car_xmax,
            float car_ymin, float car_ymax, float car_zmax, float min_radius,
   ...
   * @return int
   */
  int id() { return valid_node_number_; }
