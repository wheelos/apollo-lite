...
#include "modules/traffic_light/proto/traffic_light_component.pb.h"
...
DetectorBackendType ConvertDetectorBackend(
    apollo::traffic_light::TrafficLightDetectorBackend backend) {
  switch (backend) {
    case apollo::traffic_light::TL_DETECTOR_YOLO:
    default:
...
LightColor ConvertClassColor(
    apollo::traffic_light::TrafficLightClassColor color) {
  switch (color) {
    case apollo::traffic_light::TL_CLASS_RED:
      return LightColor::RED;
    case apollo::traffic_light::TL_CLASS_YELLOW:
      return LightColor::YELLOW;
    case apollo::traffic_light::TL_CLASS_GREEN:
      return LightColor::GREEN;
    case apollo::traffic_light::TL_CLASS_BLACK:
      return LightColor::BLACK;
    case apollo::traffic_light::TL_CLASS_UNKNOWN:
    default:
      return LightColor::UNKNOWN;
  }
}
...
ComponentOptions ToOptions(
    const apollo::traffic_light::TrafficLightComponentConfig& proto) {
...
bool TrafficLightComponent::LoadOptions() {
  apollo::traffic_light::TrafficLightComponentConfig config;
