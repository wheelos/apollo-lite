...
#include "modules/perception/inference/tensorrt/rt_common_without_protobuf.h"
...
class RPNProposalSSDPlugin : public nvinfer1::IPlugin {
 public:
  RPNProposalSSDPlugin(
    ...
    StNMSSSDParameter nms_param = detection_output_ssd_param.nms_param;
...
class RPNProposalSSDPlugin : public nvinfer1::IPluginV2Ext {
 public:
  ...
  void setPluginNamespace(
      const nvinfer1::AsciiChar *libNamespace) noexcept override {
  ...
  bool canBroadcastInputAcrossBatch(
      int32_t inputIndex) const noexcept override {
    return false;
  }
