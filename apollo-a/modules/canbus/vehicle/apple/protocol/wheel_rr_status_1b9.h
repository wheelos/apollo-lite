...
class Wheelrrstatus1b9 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Wheel_rr_status_1b9::Errorcode_rrType errorcode_rr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int statusword_rr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double torque_rr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double speed_rr(const std::uint8_t* bytes, const int32_t length) const;
};
