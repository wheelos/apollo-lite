...
RUN bash -eux /opt/apollo/installers/install_minimal_environment.sh --install-mode dev --compute-mode cuda \
    ...
    && bash -eux /opt/apollo/installers/install_modules_base.sh \
